// Fuente de siembra de productos. El catálogo real vive en la base de datos
// (modelo Product); este array solo alimenta el seed inicial e idempotente
// (prisma/seed-products.ts). No importar desde el storefront: usar los helpers
// async de app/lib/products.ts.
