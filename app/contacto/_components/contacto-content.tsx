              ...
              {sent ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    disabled={sending}
                    className="inline-flex items-center gap-2 bg-cocoa text-white font-semibold px-8 py-4 rounded-lg hover:bg-cocoa-deep transition-colors disabled:opacity-60"
                  >
